...
class Datasets
{
    ...
    public const CA_PROVINCES = 'AB|Alberta,BC|British Columbia,MB|Manitoba,NB|New Brunswick,NL|Newfoundland and Labrador,NS|Nova Scotia,NT|Northwest Territories,NU|Nunavut,ON|Ontario,PE|Prince Edward Island,QC|Quebec,SK|Saskatchewan,YT|Yukon';

    public const AU_STATES = 'ACT|Australian Capital Territory,NSW|New South Wales,NT|Northern Territory,QLD|Queensland,SA|South Australia,TAS|Tasmania,VIC|Victoria,WA|Western Australia';

    public const MONTHS = '1|January,2|February,3|March,4|April,5|May,6|June,7|July,8|August,9|September,10|October,11|November,12|December';
